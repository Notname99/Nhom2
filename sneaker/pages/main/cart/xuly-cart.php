        ...
        case "submit":
            ...
            if (isset($_POST['update_click'])){
                ...
                if ($error == false && !empty($_POST['soluong'])){
                    ...
                    $insertOrrder = "INSERT INTO `tb_giohang` (`id`, `tendh`, `phone`, `diachi`, `ghichu`, `tongtien`, `created_time`, `last_updated`) VALUES (NULL, '".$_POST['name']."', '".$_POST['phone']."', '".$_POST['address']."', '".$_POST['note']."', '".$tong."', '".time()."', '".time()."')";
