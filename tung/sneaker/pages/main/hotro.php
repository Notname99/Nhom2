<!-- <div class="cach"></div> -->
<div class="hotro">
    <p>Để được hỗ trợ, vui lòng nhập thông tin bên dưới và ấn Gửi. Team SaigonSneaker sẽ trả lời quí khách qua email trong vòng 24h.</p>
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="email" name="email" class="inp form-control" id="exampleFormControlInput1" placeholder="name@example.com">
        </div>
        <div class="form-group">
            ...
            <textarea class="inpt form-control" id="exampleFormControlInput1" name="conten" placeholder="Yêu cầu cần hỗ trợ" cols="10" rows="10"></textarea>
        </div>
    ...
    if (isset($_POST['button'])) {
        ...
        if (!empty($user) && !empty($email) && !empty($conten)) {
            //nhập dữ liệu
            $insert = "INSERT INTO `tb_hotrokhachang` (`id`, `ten`, `email`, `noidung`) VALUES (NULL, '$user', '$email', '$conten')";
