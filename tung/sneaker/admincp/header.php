<div class="header">
    ...
    <div id="list">
        <nav class="list-nav">
            <ul id="main-menu">
                <li class="menu-item"><a href="../../index.php?quanly=Adidas&id=1&per_page=12&page=1">Adidas</a></li>
                <li class="menu-item"><a href="../../index.php?quanly=Nike&id=1&per_page=12&page=1">Nike</a></li>
