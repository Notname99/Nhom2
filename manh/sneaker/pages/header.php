<div class="header">
    ...
    <div class="list">
        <ul class="list-ul">
            ...
            <li class="list-li">
                <div class="dropdown">
                    <a class="dropbtn" href="#">New Balance</a>
                    <div class="dropdown-content">
                        <a href="#">Link 1</a>
                        <a href="#">Link 2</a>
                        <a href="#">Link 3</a>
            ...
            <li class="list-li">
                    ...
                    <a class="dropbtn" href="../../index.php?quanly=mlb&id=4"> MLB </a>
                
            </li>
            <li class="list-li">

                <a class="dropbtn" href="../../index.php?quanly=balenciaga&id=5"> Balenciaga </a>
